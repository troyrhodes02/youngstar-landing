    ...
    <div className="container mx-auto px-4 py-16 flex flex-col items-center">
      <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-8 text-center">
        ...
        <p className="text-md text-gray-600 mb-8">
          ...
          any questions about your order, please contact our customer support.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-4 border border-gray-200 rounded-md">
            ...
            <p className="text-gray-600">
              We'll verify your order details and prepare your items for
              shipping.
            </p>
          </div>
          ...
          <div className="p-4 border border-gray-200 rounded-md">
            ...
            <p className="text-gray-600">
              Your order will be packed and shipped. You'll receive a tracking
              number via email.
            </p>
          </div>
