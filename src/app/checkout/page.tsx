    ...
    <div className="min-h-screen bg-black text-white pb-20 pt-24">
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold tracking-widest uppercase border-b-2 border-red-600 pb-2">Checkout</h1>
        </div>

        <div className="flex flex-col lg:flex-row gap-10">
          {/* Customer Information Form */}
          <div className="w-full lg:w-2/3">
            <form onSubmit={handleSubmit} className="bg-zinc-900 rounded-lg p-8 shadow-xl border border-zinc-800">
              <h2 className="text-2xl font-bold uppercase tracking-wide mb-6 flex items-center">
                <span className="bg-red-600 text-white rounded-full w-7 h-7 inline-flex items-center justify-center mr-3">1</span>
              ...
              <h2 className="text-2xl font-bold uppercase tracking-wide mb-6 mt-10 flex items-center">
                <span className="bg-red-600 text-white rounded-full w-7 h-7 inline-flex items-center justify-center mr-3">2</span>
                Shipping Address
              </h2>

              <div className="mb-6">
                <label htmlFor="address" className="block text-sm uppercase tracking-wide mb-2">
                  Street Address*
                </label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div>
                  <label htmlFor="state" className="block text-sm uppercase tracking-wide mb-2">
                    State*
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="zipCode" className="block text-sm uppercase tracking-wide mb-2">
                    ZIP Code*
                  </label>
                  <input
                    type="text"
            ...
            <div className="bg-zinc-900 rounded-lg shadow-xl border border-zinc-800 overflow-hidden">
              ...
              <div className="p-6">
                <div className="max-h-72 overflow-y-auto mb-6 pr-2 space-y-4">
                  {cart.map((item) => (
                    <div key={item.id} className="flex py-3 border-b border-zinc-800">
                      {item.image && (
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-sm font-bold mt-1">${(item.price * item.quantity / 100).toFixed(2)}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-3 py-4 border-t border-zinc-800">
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm font-medium">${(totalPrice / 100).toFixed(2)}</p>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="flex justify-between pt-4 border-t border-zinc-800 mt-4">
                  ...
                  <p className="text-lg font-bold text-red-600">${(totalPrice / 100).toFixed(2)}</p>
                </div>
