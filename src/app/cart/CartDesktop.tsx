...
export const CartDesktop = () => {
  ...
  const handleProceedToSquareCheckout = async () => {
    ...
    try {
      ...
      console.log("Sending to /api/square-checkout:", {
        items: squareItems,
  ...
  if (cart.length === 0) {
    return (
      ...
      >
        <FaShoppingCart
          style={{ fontSize: 50, marginBottom: 24, color: "red" }}
        />
        <Typography
          variant="h4"
          component="h1"
  ...
  const Connector = () => (
    <Box
      sx={{ height: 80, width: 2, bgcolor: "grey.700", mx: "auto", my: 1 }}
    />
  );
        ...
        <Grid container spacing={5}>
          ...
          <Grid item xs={12} lg={4}>
            ...
            >
              ...
              <Box sx={{ p: 3 }}>
                <Stack
                  sx={{ maxHeight: 380, overflowY: "auto", mb: 2, pr: 1 }}
                ...
                {shippingAddress.firstName && shippingAddress.address && (
                  <Paper
                    sx={{ mb: 2.5, p: 2, bgcolor: "#2a2a2a", borderRadius: 1 }}
                  >
                    <Stack
                      direction="row"
                      spacing={1.5}
                    ...
                    >
                      <FaMapMarkerAlt
                        style={{ color: "red", marginTop: 4, flexShrink: 0 }}
                      />
                      <Box>
                        <Typography
                          variant="body2"
                ...
                <Stack
                  spacing={1.5}
                  sx={{ py: 2, borderTop: "1px solid #333" }}
                >
                ...
                <Stack
                  direction="row"
                  justifyContent="space-between"
                  sx={{ pt: 2, borderTop: "1px solid #333", mt: 2 }}
                >
                  <Typography
                    variant="h6"
                    sx={{
